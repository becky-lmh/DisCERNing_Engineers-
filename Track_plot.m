...
% pionCharge = extractKaon(collision_tab);
...
%% compare kaon momentum to pion momentun
% figure()
% histogram(massEnergy_,20);
% set(gca,'yscale','log')
% grid on
% xlabel("Momentum / MeV")
% ylabel("Number of charged kaons")
% mean(massEnergy_)
